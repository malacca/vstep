...
var createRequest = function (url, option) {
    ...
    var r = new Request(isHttpUrl(url) ? url : getApiBaseUrl() + removeDoubleSalash(url), options);
    r._url = url;
    return r;
};
...
function loader(page) {
    return new Promise(function (resolve, reject) {
        require(['view/' + page], resolve, function(error) {
...
function app() {
    ...
    requirejs.config({
        baseUrl: baseUrl,
        paths: {"ELEMENT":["https://cdn.jsdelivr.net/npm/element-ui@2.9.1/lib/index","lib/element"],"vue":["https://cdn.jsdelivr.net/npm/vue@2.6.10/dist/vue.runtime.min","lib/vue"],"vue.router":["https://cdn.jsdelivr.net/npm/vue-router@3.0.6/dist/vue-router.min","lib/vue-router"]},
        callback:launcher
    });
}app()
})()